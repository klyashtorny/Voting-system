...
public class DishTestData {
    ...
    public static final Dish DISH_3 = new Dish(DISH_ID + 1, "Soup", 300);

    public static final Dish DISH_4 = new Dish(DISH_ID + 4, "Fish", 400);
    public static final Dish DISH_5 = new Dish(DISH_ID + 5, "Salad", 300);
    public static final Dish DISH_6 = new Dish(DISH_ID + 3, "Starter", 100);
